...
from .models import Movie, Review, ReviewComment, MovieComment
...
class MovieSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Movie
        fields = ['id', 'title', 'release_date', 'popularity', 'vote_count', 'vote_average', 'overview', 'poster_path', 'genres', 'like_users', 'users_playlist']
